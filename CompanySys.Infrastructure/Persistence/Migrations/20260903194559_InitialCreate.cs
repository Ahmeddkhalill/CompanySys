    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamMembers", x => new { x.TeamId, x.EngineerId });
                    table.ForeignKey(
                        name: "FK_TeamMembers_AspNetUsers_EngineerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAssignments", x => new { x.TaskId, x.EngineerId });
                    table.ForeignKey(
                        name: "FK_TaskAssignments_AspNetUsers_EngineerId",
                        column: x => x.EngineerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_EngineerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_EngineerId",
                table: "TeamMembers",
                column: "EngineerId");
